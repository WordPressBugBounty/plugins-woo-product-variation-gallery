...
*
* The payload is merged into the existing `rtwpvg` option server-side, so keys
* that are not sent (e.g. Pro-only fields for free users) are preserved.
*/
async function saveSettings(options) {
	const { ajaxUrl, nonce, saveAction } = window.rtwpvgSettings;
...
/**
* Activate or deactivate the Pro license via the pro `rtwpvg_manage_licensing`
* AJAX handler. The license key is persisted server-side before the request.
*/
async function manageLicense(type, licenseKey) {
	const { ajaxUrl, licenseNonce, licenseAction } = window.rtwpvgSettings;
	const body = new FormData();
...
var LAYOUT_TYPES = /* @__PURE__ */ new Set([
	"title",
	"feature",
	"card"
]);
...
function getSaveableFields() {
	const { sections } = window.rtwpvgSettings;
...
function fieldMatchesCondition(field, options) {
	...
	const matches = typeof expected === "boolean" ? toBool(actual) === expected : String(actual) === String(expected);
	return field.condition.compare === "!=" ? !matches : matches;
}
...
var AUTOSAVE_TOAST_ID = "rtwpvg-autosave";
/**
...
function buildPayload(options, ids) {
	const { isPro } = window.rtwpvgSettings;
	...
	for (const id of ids) {
		...
		if (field.type === "checkbox" || field.type === "switch") value = toBool(value) ? 1 : 0;
		payload[id] = value ?? "";
	}
	return payload;
}
...
var useStore = create((set, get) => ({
	options: { ...window.rtwpvgSettings.values },
	errors: {},
	focusField: null,
	licenseStatus: window.rtwpvgSettings.licenseStatus,
	isDirty: false,
	isSaving: false,
	searchOpen: false,
	proAlertOpen: false,
	...
	save: async () => {
		...
		if (missing.length > 0) {
			const strings = window.rtwpvgSettings.strings;
			const errors = {};
		...
		try {
			...
			zt.success(window.rtwpvgSettings.strings.saved, { id: AUTOSAVE_TOAST_ID });
		} catch (err) {
...
*/
function Topbar() {
	const { version, docUrl, supportUrl } = window.rtwpvgSettings;
...
*/
function Sidebar() {
	const { sections, strings, isPro, proUrl, logoUrl } = window.rtwpvgSettings;
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
		className: cn("rtwpvg-sidebar relative flex h-full shrink-0 flex-col border-r border-[var(--color-line)] bg-[var(--color-surface)] transition-[width] duration-200", collapsed ? "w-16" : "w-64"),
		children: [
...
function FieldRow({ field, locked, children }) {
	...
	const label = Boolean(field.is_pro) && !window.rtwpvgSettings.isPro ? `${field.title ?? ""} <span class="rtwpvg-pro">[Pro]</span>` : field.title ?? "";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [field.title && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
				...
				className: "rtwpvg-rich mt-1 mb-0! text-[14px]! leading-normal text-[#6B6B78]",
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [locked && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
					"aria-label": window.rtwpvgSettings.strings.proField,
...
function ColorField({ field, locked }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			className: "rtwpvg-swatch-bg relative h-6 w-6 shrink-0 overflow-hidden rounded-md border border-[#D0D0D8]",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
//#endregion
//#region src/admin/components/fields/ImageField.tsx
/**
* Attachment picker backed by the WordPress media library.
*
* The stored value is the attachment ID (matching the legacy `image` field);
* the preview URL is seeded from `imageUrls` on first render and replaced
* locally whenever a new attachment is selected, so no reload is needed.
*/
function ImageField({ field, locked }) {
	const value = useStore((s) => s.options[field.id]);
	const setOption = useStore((s) => s.setOption);
	const { imageUrls, strings } = window.rtwpvgSettings;
	const [previewUrl, setPreviewUrl] = (0, import_react.useState)(imageUrls?.[field.id] ?? "");
	const frameRef = (0, import_react.useRef)(null);
	const hasImage = (value ? Number(value) : 0) > 0 && previewUrl !== "";
	const openPicker = () => {
		if (locked) return;
		const media = window.wp?.media;
		if (!media) {
			console.error("[rtwpvg] wp.media is not available on this screen");
			return;
		}
		if (!frameRef.current) {
			const frame = media({
				title: strings.selectImage || "Select Image",
				button: { text: strings.selectImage || "Select Image" },
				library: { type: "image" },
				multiple: false
			});
			frame.on("select", () => {
				...
				setOption(field.id, attachment.id);
				setPreviewUrl(attachment.sizes?.medium?.url ?? attachment.url);
			});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
			...
			onClick: openPicker,
			disabled: locked,
			className: "flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-[9px]! border! border-dashed! border-[#D0D0D8]! bg-white transition-colors duration-200 hover:border-[var(--color-brand)]!",
			children: hasImage ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				src: previewUrl,
				alt: "",
				className: "h-full w-full object-contain"
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
				className: "h-6 w-6 text-[#9A9AA8]",
				viewBox: "0 0 24 24",
				fill: "none",
				stroke: "currentColor",
				strokeWidth: 1.7,
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				onClick: openPicker,
				disabled: locked,
				className: "rounded-[9px] bg-[var(--color-brand)] px-4 py-2 text-[13px] font-semibold text-white transition-colors duration-200 hover:bg-[var(--color-brand-dark)]",
				children: hasImage ? strings.changeImage || "Change Image" : strings.selectImage || "Select Image"
			}), hasImage && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				type: "button",
				onClick: remove,
				disabled: locked,
				className: "text-[13px] font-medium text-[#9A9AA8] transition-colors hover:text-red-600",
				children: strings.removeImage || "Remove"
			})]
		})]
	});
}
...
* the pro `rtwpvg_manage_licensing` AJAX handler.
*/
...
/**
* Dispatches a field definition to the matching control (`title` -> heading
* band, `feature` -> raw HTML, everything else -> a labelled field row).
*/
function RenderField({ field }) {
	...
	if (field.type === "title") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "rtwpvg-heading-area flex items-center justify-between gap-4 border-y border-[var(--color-line)] border-l-[3px] border-l-[var(--color-brand)] bg-[var(--color-brand-soft)] px-5 py-3",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "min-w-0",
			children: [field.title && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				...
				className: "rtwpvg-rich mt-0.5! mb-0! text-[13px]! text-[#6B6B78]",
				dangerouslySetInnerHTML: { __html: field.desc }
			})]
	...
	if (field.type === "feature") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "rtwpvg-rich border-b border-[#ECECEF] py-5 last:border-b-0",
		dangerouslySetInnerHTML: { __html: field.html ?? "" }
	});
	const control = (() => {
		switch (field.type) {
			case "checkbox":
			case "switch": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SwitchField, {
				field,
				locked
			});
			case "radio":
			...
			case "image": return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ImageField, {
				field,
				locked
			});
			...
			default:
				if ("license_key" === field.id) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LicenseField, {
					field,
					locked
				});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [(title || desc) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [title && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "rtwpvg-settings-sub-title m-0! text-[22px] font-semibold tracking-tight text-[var(--color-ink)]",
				children: title
			}), desc && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "rtwpvg-rich mt-1! mb-0! max-w-[640px] text-[14px]! leading-relaxed text-[#6B6B78]",
	...
	if (section.id === "premium_plugins") return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				className: "rtwpvg-settings-sub-title mb-0! text-[22px] font-semibold tracking-tight text-[#0F0F14]",
				children: section.title
			}), section.desc && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "rtwpvg-rich mt-2 mb-0! text-[14px]! leading-relaxed text-[#6B6B78]",
...
*/
function SaveBar() {
	const { strings, reviewUrl } = window.rtwpvgSettings;
	const pluginName = strings.pageTitle || "Variation Gallery";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
* (#rtwpvg-main), so reset that container alongside the window as a fallback.
*/
function ScrollToTop() {
	const { pathname } = useLocation();
	(0, import_react.useEffect)(() => {
		const main = document.getElementById("rtwpvg-main");
...
function extractFields() {
	const fields = [];
	for (const section of window.rtwpvgSettings.sections) for (const field of section.fields) {
	...
	const handleSelect = (0, import_react.useCallback)((field) => {
		...
		setTimeout(() => {
			...
			if (el) {
				...
				el.classList.add("rtwpvg-flash");
				setTimeout(() => el.classList.remove("rtwpvg-flash"), 1600);
			}
		}, 120);
...
function ProAlertModal() {
	...
	const setProAlertOpen = useStore((s) => s.setProAlertOpen);
	const { proUrl, strings } = window.rtwpvgSettings;
	(0, import_react.useEffect)(() => {
		if (!isOpen) return;
		const onKey = (e) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		onClick: close,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "rtwpvg-modal-fade absolute inset-0 bg-slate-900/50 backdrop-blur-[3px]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			role: "dialog",
			"aria-modal": "true",
			"aria-label": strings.proAlertTitle || "Pro field alert!",
			className: "rtwpvg-modal-pop relative w-full max-w-[480px] overflow-hidden rounded-3xl bg-white text-center shadow-[0_30px_80px_-12px_rgba(15,23,42,0.35)] ring-1 ring-black/5",
			onClick: (e) => e.stopPropagation(),
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				"aria-hidden": "true",
...
function FocusField() {
	...
	(0, import_react.useEffect)(() => {
		...
		const timer = setTimeout(() => {
			...
			el.classList.remove("rtwpvg-flash-error");
			el.offsetWidth;
			el.classList.add("rtwpvg-flash-error");
			setTimeout(() => el.classList.remove("rtwpvg-flash-error"), 2e3);
		}, 120);
...
function App() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(HashRouter, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "rtwpvg-app flex h-full min-h-0 overflow-hidden",
			children: [
...
*/
function mount() {
	console.log("[rtwpvg] settings bundle loaded", window.rtwpvgSettings);
	const container = document.getElementById("rtwpvg-settings-root");
	if (!container) {
		console.error("[rtwpvg] #rtwpvg-settings-root not found in DOM");
		return;
	}
	if (!window.rtwpvgSettings || !Array.isArray(window.rtwpvgSettings.sections)) {
		console.error("[rtwpvg] window.rtwpvgSettings is missing or malformed", window.rtwpvgSettings);
		container.innerHTML = "<div style=\"padding:16px;border:1px solid #dc2626;border-radius:8px;color:#dc2626;font:14px sans-serif\">Variation Gallery: settings data failed to load. Check the browser console.</div>";
		return;
	}
	try {
		...
		console.error("[rtwpvg] failed to render settings app", err);
		container.innerHTML = "<div style=\"padding:16px;border:1px solid #dc2626;border-radius:8px;color:#dc2626;font:14px sans-serif\">Variation Gallery: the settings UI crashed while rendering. Check the browser console.</div>";
	}
}
