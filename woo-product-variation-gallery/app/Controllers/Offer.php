			...
			function () {
				...
				<div class="notice notice-info is-dismissible" data-rtwpvgdismissable="rtwpvg_ny_2023"
					...
					<img alt="<?php echo esc_attr( $plugin_name ); ?>"
						src="<?php echo rtwpvg()->get_assets_uri( 'images/icon-128x128.gif' ); // phpcs:ignore ?>" width="74px" />
								...
								$('div[data-rtwpvgdismissable] .notice-dismiss, div[data-rtwpvgdismissable] .button-dismiss')
									.on('click', function (e) {
										...
										$.post(ajaxurl, {
											...
											'nonce': <?php echo json_encode( wp_create_nonce( 'rtwpvg-dismissible-notice' ) ); //phpcs:ignore ?>
										});
			...
			function () {
				...
				<div class="notice notice-info is-dismissible" data-woobundlebfdismissable="woobundle_black_friday_offer_2024"
					...
					<img alt="<?php echo esc_attr( $plugin_name ); ?>"
						 src="<?php echo rtwpvg()->get_assets_uri( 'images/icon-128x128.gif' ); // phpcs:ignore ?>" width="74px"
						 height="74px" style="grid-row: 1 / 4; align-self: center;justify-self: center"/>
					<h3 style="margin:0; position: relative;display: flex; align-items: center;">WooCommerce Bundle [Black Friday <img style="width: 40px;position: relative;" src="<?php echo rtwpvg()->get_assets_uri( 'images/deal.gif' ); // phpcs:ignore ?>">]</h3>
								...
								$('div[data-woobundlebfdismissable] .notice-dismiss, div[data-woobundlebfdismissable] .button-dismiss')
									.on('click', function (e) {
										...
										$.post(ajaxurl, {
											...
											'nonce': <?php echo json_encode( wp_create_nonce( 'woobundle-black-friday-offer-2024' ) ); // phpcs:ignore ?>
										});
										$(e.target).closest('.is-dismissible').remove();
									});
							}, 1000);
